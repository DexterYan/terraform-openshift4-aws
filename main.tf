...
module "dns" {
  ...
  region                                      = var.aws_region
  publish_strategy                            = var.aws_publish_strategy
  aws_vpc_endpoint_private_ec2_dns_name       = module.vpc.aws_vpc_endpoint_private_ec2_dns_name
  aws_vpc_endpoint_private_ec2_hosted_zone_id = module.vpc.aws_vpc_endpoint_private_ec2_hosted_zone_id
}
